      ...
      <div className="flex flex-wrap justify-center gap-6 mx-auto mt-4">
        {projects.map((project, i) => (
          <motion.a
            ...
            className="glass group cursor-pointer overflow-hidden transition-all duration-300 hover:bg-white/[0.06] hover:border-white/[0.12] hover:shadow-[0_0_50px_rgba(99,102,241,0.08)] block w-full sm:w-[calc(50%-12px)] lg:w-[calc(33.333%-16px)]"
          >
            {/* Project Image */}
